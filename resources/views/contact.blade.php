                ...
                <div class="mt-8 lg:w-1/2 lg:mx-6">
                    ...
                    >
                        ...
                        <form class="mt-6">
                            ...
                            <button
                                class="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-emerald-500 rounded-md hover:emerald-blue-400 focus:outline-none focus:ring focus:ring-emerald-300 focus:ring-opacity-50"
                            >
                                get in touch
                            </button>
                        </form>
